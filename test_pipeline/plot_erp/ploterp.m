function ploterp(letter)
    base = 'C:\Users\vinay\Documents\test_pipeline\plot_erp\';
  %  xdffile = strcat(base,date,'\',subject,'\',letter,'.xdf');
    xdffile = 'C:\Users\vinay\Downloads\LabRecorder-1.16.2-Win_amd64\LabRecorder\foo.xdf';
    bstfile = strcat(base,'5_bsts\5_',letter,'.txt');
    chan_locs_file = strcat(base,'channel_locs.ced');
    eventsfile = strcat(base,letter,'_events.txt');
    bins_saved_in = strcat(base,letter,'_bins.txt');
