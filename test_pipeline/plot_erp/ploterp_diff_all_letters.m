function ploterp_diff_all_letters(date,subject,letter)
  ...
  [ALLEEG, EEG, ~] = pop_newset(ALLEEG, EEG, 2,'setname','ch1248_0.1to30Hz','gui','off'); 
    ...
    ERP = pop_averager( ALLEEG , 'Criterion', 'good', 'DQ_custom_wins', 0, 'DQ_flag', 1, 'DQ_preavg_txt', 0, 'DSindex', 5, 'ExcludeBoundary',...
     'on', 'SEM', 'on' );
   ERP = pop_binoperator( ERP, {  'Bin13 = Bin1 - Bin2 label q-Diff',  'Bin14 = Bin3 - Bin4 label p-Diff',  'Bin15 = Bin5 - Bin6 label h-Diff',...
  'Bin16 = Bin7 - Bin8 label f-Diff',  'Bin17 = Bin9 - Bin10 label b-Diff',  'Bin18 = Bin11 - Bin12 label w-Diff'});
   ERP = pop_ploterps( ERP,  13:18,  1:4 , 'AutoYlim', 'on', 'Axsize', [ 0.05 0.08], 'BinNum', 'on', 'Blc', 'pre', 'Box', [ 2 2], 'ChLabel',...
